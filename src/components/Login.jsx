...
const Login = () => {
  ...
  return (
    <div className='mx-10 my-[100px] md:m-auto md:my-[100px] max-w-[700px] justify-center p-10 shadow-slate-700 shadow-2xl bg-[#242421] rounded-2xl font-montserrat border border-md border-slate-600' >
